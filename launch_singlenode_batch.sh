...
python -m gen_model_answer --model-path \$MODEL_PATH --model-id \$MODEL_ID
python -m gen_judgment --model-list \$MODEL_ID --parallel 2
python -m show_result --model-list \$MODEL_ID
